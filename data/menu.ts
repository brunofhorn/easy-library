...
export const menus: IMenu[] = [
    ...
    { id: 6, name: "Empréstimos", icon: "carbon:global-loan-and-trial", active: false, color: "", href: "/dashboard/loans" },
    { id: 7, name: "Relatórios", icon: "tabler:report", active: false, color: "", href: "/dashboard/reports" },
];