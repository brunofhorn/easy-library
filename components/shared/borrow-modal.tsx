...
const BorrowModal = ({
    ...
    return (
        <Modal showModal={showBorrowModal} setShowModal={setShowBorrowModal}>
...
export function useBorrowModal() {
    ...
    const BorrowModalCallback = useCallback(() => {
        return (
            <BorrowModal
    ...
    return useMemo(
        () => ({ setShowBorrowModal, BorrowModal: BorrowModalCallback }),
        [setShowBorrowModal, BorrowModalCallback],
    );
}
